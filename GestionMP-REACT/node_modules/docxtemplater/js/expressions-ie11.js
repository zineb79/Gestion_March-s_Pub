...
function _getObjectIdentifiers(x) {
  ...
  if (x.body) {
    for (var _i2 = 0, _x$body2 = x.body; _i2 < _x$body2.length; _i2++) {
      var y = _x$body2[_i2];
  ...
  if (x.type === "CallExpression") {
    ...
    if (x.arguments) {
      for (var _i4 = 0, _x$arguments2 = x.arguments; _i4 < _x$arguments2.length; _i4++) {
        var _y = _x$arguments2[_i4];
...
function configuredParser() {
  ...
  return function expressionParser(tag) {
     ...
     */
    var isAssignment = expr.ast.body[0] && expr.ast.body[0].expression.type === "AssignmentExpression";
    return {
      get: function get(scope, context) {
        var obj = {};
        var scopeList = context.scopeList;
        var index = getIndex(scope, context);
        var num = context.num;
